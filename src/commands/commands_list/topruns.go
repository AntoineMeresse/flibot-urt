...
func ToprunsInformation(cmd *models.CommandsArgs) {
	displayRunsInformation(cmd, true)
}

func TopInformation(cmd *models.CommandsArgs) {
	displayRunsInformation(cmd, false)
}

func displayRunsInformation(cmd *models.CommandsArgs, displayAll bool) {
