...
var Commands = map[string]Command{
	...
	"roll":       {Function: commandslist.Roll, excludeFromBridge: true},
	...
	"kms":        {Function: commandslist.Kms, excludeFromGuess: true},
	...
	"savepreferences": {Function: commandslist.SavePreferences, Usage: "!savepreferences [!lo] [!invisible] [!trad]", excludeFromBridge: true},
	"say":             {Function: commandslist.Say, Usage: "!say [message]", excludeFromBridge: true},
